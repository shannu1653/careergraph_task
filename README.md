...
| 🎯 **Career Matching** | Finds suitable career paths based on the user's skills |
| 📊 **Match Percentage** | Shows how closely the user's skills match a career |
| 🧩 **Skill Gap Analysis** | Identifies missing skills required for a selected career |
...
Follow the steps below to run CareerGraph locally.
...
🔗 Important Links
Resource	Link
🌐 Live Application	https://careergraph-task-v3m0.onrender.com
💻 GitHub Repository	https://github.com/shannu1653/careergraph_task
📌 Project Summary
...
<p align="center"> <strong>🚀 CareerGraph</strong> <br> <sub>Discover where your skills can take you.</sub> </p> ```